  ...
  return (
    <Tilt className="xs:w-[220px]  glass-effect w-full  rounded-xl">
      ...
      >
        ...
        className="w-full  shadow-xl border border-neutral-800 p-4 rounded-2xl flex flex-col  items-center justify-center gap-2">
...
<div id="about" className={`px-4 md:px-0 flex flex-col items-center justify-center text-center`}>
     ...
     <motion.div
      ...
      <div className="mt-8 md:mt-24 flex flex-end justify-end flex-wrap gap-10">
