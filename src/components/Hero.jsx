  ...
  return (
    <>
      ...
      <div className="w-full">
        <div
          className={`px-4 sm:px-0 py-2 mb-16  md:py-24   flex-col-reverse flex lg:flex-row  w-full max-w-7xl mx-auto`}
        >
          <section
            ...
            <div className="w-full lg:w-1/2 md:px-10 pt-5 sm:py-10">
              ...
              >
                ...
                <div className="text-center sm:text-left sm:pr-10">
                  <p className="mt-1 text-base font-mono font-thin  text-neutral-400">
                    Hi, I'm{" "}
                    <span className="text-red-500 uppercase font-mono font-black">
                      God'spower{" "}
                      <i
                        className="fa fa-hand-peace-o text-4xl text-red-500 animate-bounce"
                        aria-hidden="true"
                      ></i>
                    </span>
                  </p>
                  ...
                  <p className="mt-8 sm:pr-10 text-neutral-600  text-[18px] sm:text-[20px] text-center sm:text-left font-medium leading-7">
             ...
             hover:shadow text-xs font-semibold cursor-pointer`}
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="text-[14px] font-mono font-black">{link.title}</span>
                      </a>
                    </li>
                  ))}
                </ul>
        ...
        <div className="absolute -bottom-20 xs:bottom-24 w-full flex justify-center items-center">
          <a href="#about">
